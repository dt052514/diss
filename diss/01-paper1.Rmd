...
```{r distributions, fig.height = 3, fig.width = 6, dpi=300, fig.cap='Distribution of International Subsidiaries', out.width='80%', fig.align='center'}
...
```{r scatter01,fig.cap='NOC Internationalization: Total number of International Subsidiaries (x) correlates strongly with breadth of the international subsidiary network (y). Points sized by median number of subsidiaries per location.', fig.height = 4, fig.width = 6,out.width='80%',  dpi=300,fig.align= 'center'}
nocdata::subsidiaries %>% 
...
```{r t6map, fig.height = 3.5, fig.width = 8, fig.align= 'center', dpi=500}
