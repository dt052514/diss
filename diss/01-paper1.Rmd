...
### What do we know about NOCs?

Academic research into NOCs can be roughly grouped into four categories. First, scholarship across several disciplines has sought to address the question of why NOCs exist in the first place. The earliest of these focus on the historical genesis of NOCs as oil supply managers and evolution into production and export businesses. Many focus on explaining why states rely on state-owned firms instead of a competitive market for production and distribution [eg. @tordo_national_2011]. Recent scholarship in this vein focuses on the nationalization process that generated many NOCs [@mahdavi_why_2014]. Many of these studies focus on a particular region and draw comparisons across a limited set of NOCs [eg. @marcel_oil_2006].

Second, a body research --- developed in particular, but not exclusively, by applied economists --- has investigated the economic activity of NOCs. Many of these studies examine and compare the efficiency and effectiveness of NOCs as economic entities, particularly in relation to non-state owned peers [eg. @hartley_model_2008; @eller_empirical_2011; @thurber_exporting_2011; @victor_states_2012]. A useful review of both of these first literatures, focusing on historical genesis and economic efficiency, can be found in @victor_national_2013.

Hydrocarbons are a foundational component to modern political science^[Foundational, in that canonical texts in international political economy in particular were developed to explain, in large part, political phenomena in energy policy and energy security. See @krasner_defending_1978, @keohane_after_1984, @ikenberry_irony_1986, and @ikenberry_reasons_1988.], but political scientists have devoted limited attention to NOCs in particular. This lack of attention is surprising, given that NOCs are one of the most important institutions at the intersection of hydrocarbon wealth and the state. Some exceptions exist. @jones_luong_domestic_2015 argue that ownership institutions --- NOCs most prominent among them --- are essential to understanding the causal process that connects hydrocarbon endowments with outcomes like economic and political development^[See @losman_rentier_2010 for another example, focused on the Middle East]. @cheon_instruments_2014 examine some of the ways that states can use their NOCs strategically for domestic ends, in particular by insulating domestic consumer markets from adverse trends in oil prices. Strategic concerns and political economy also feature prominently in some of the core omnibus analyses of NOCs [eg. @victor_oil_2012;@marcel_oil_2006]. Overall, however, research into NOCs continues to be marginal in political science and political economy.^[ A recent *Annual Review of Political Science* survey on "The Politics of Energy", tellingly, makes no explicit references to NOCs, despite a few citations pointed towards research that focus exclusively on NOCs [@hughes_politics_2013].]

This relative lack of attention extends to international relations and international political economy. While NOC internationalization has drawn some interest from the popular press,^[eg. A special issue on the topic in *The Economist* in 2012 [@noauthor_new_2012]. See also [@noauthor_leviathan_2014].] relatively few political economists have addressed the phenomenon of NOCs expanding into international markets. The bulk of academic work in this area has been pursued by business studies scholars. This research addresses a number of key questions related to NOC internationalization Many of these studies leverage detailed Chinese firm-level outbound foreign direct investment (FDI) data to test their hypotheses. @cui_state_2012 find that state ownership modifies how Chinese firms engage in FDI, in particular by increasing the degree to which these firms conform to target market institutional pressures^[@meyer_overcoming_2014 find supporting evidence for this argument.]. @liang_anatomy_2014 unpack state control, finding evidence that formal and informal mechanisms of control and influence have varying effects on Chinese state-owned outward FDI. @duanmu_state-owned_2014 find that state-ownership may help investing firms counter the risk of expropriation through the political influence of their state owner. @pan_firms_2014 find that state ownership moderates investing firms' preference for high ownership states in favorable target markets: firms that have higher levels of state ownership (exercised through both formal and informal channels) demonstrate weaker preferences for high ownership in favorable markets (and for low ownership in less favorable markets)^[A complementary analysis can be found in @ramasamy_chinas_2012]. @li_diplomatic_2017 examine the value of diplomatic channels in establishing international business relationships: state-owned firms with stronger ties to their home state leverage diplomatic relationships more extensively when establishing a foreign subsidiary, and will use these relationships to inform the choice of target market. Many of these research strands are usefully summarized in @buckley_retrospective_2018.

Beyond the Chinese context, @bass_resource_2014 find that state-owned enterprises (SOEs) focus their international investments on (and pay more for) exploration, arguing that this is primarily motivated by resource scarcity and security concerns on the home (investing) state's side of the investment. @choudhury_toward_2014 modify this standard resource dependence theory in a novel way, utilizing Indian firm-level data to find evidence that SOEs engage in internationalization to improve their strategic position and independence from other state institutions (ministries, agencies, etc.).

@li_varieties_2014 develop (but do not empirically evaluate) an extensive set of theories focused on explaining the link between institutional variation ("varieties of state capitalism") and outward international investment: their core contribution is in creating a typology of SOE organizational variation. @mohr_contingent_2016 find that resource dependence isn't just a reason for state-owned firms' outward investment: international joint ventures with a state-owned party reduces the risk of joint venture dissolution as well. @musacchio_reinventing_2014 focus on Brazil to produce one of the most extensive and interesting recent treatments of contemporary state capitalism. 

Several recent studies extend this line of inquiry into political science properly speaking. @jones_luong_domestic_2015 focus on variation in Latin American NOCs to argue that patterns of internationalization can be explained by the interaction of two variables: the nationalization process that formed the firm in the first place, and the historical convergence of state and firm interests regarding internationalization. @meckling_oil_2015 utilize Indian (and Chinese) data to argue that NOC internationalization is impacted by the balance of cooperation and conflict that exists between the state and the firm in question. @chalmers_end_2017 contest the basic view that SOEs are more risk-acceptant in their choice of investment target: they find that risk acceptance varies depending on whether the firm or the state primarily owns that risk. Finally, @cheon_developing_2019 leverages a cross-national dataset of NOC mergers & acquisitions transactions to argue that domestic politics explain NOC internationalization: greater levels of partisan competition domestically reduce state tolerance for investment risk, and by extension appetite for expansion. We discuss the empirical basis for each of these studies in more detail in Section \@ref(approach01). The objective of Chapter \@ref(paper2) is to directly engage with the theoretical arguments contained in this literature.

### NOC internationalization: opportunities for research
...
```{r typology, fig.cap='A typology of the current research on NOC internationalization', out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("fig/typology.png")
```
...
## Empirical Approach: NOC Subsidiary Networks {#approach01}
...
## Analysis: Variation in NOC Internationalization {#analysis01}
...
In section \@ref(network01), we analyze the relationships between firms and subsidiaries to shed light on how NOC internationalization varies as a network. **Come back to this and build it out.**
...
### How does NOC internationalization vary? {#descriptivestats01}
...
```{r data_import ,warning=F, message=F, echo=FALSE, cache=TRUE}
subsidiaries %>% 
  as_tibble() %>% 
  select(shortname, subsidiary, relationship, country, subsidiary_country, Type, Status, stake, industry)
```
...
```{r sumstats, echo=F, message=F, warning=F, cache=T}
subsidiaries %>% 
...
```{r distributions, fig.height = 3, fig.width = 6, dpi=200, fig.cap='Distribution of International Subsidiaries', out.width='80%', fig.align='center', echo=FALSE}
...
European NOCs generally have the most international subsidiaries. Eni has 305, spread across 54 different host states. Equinor (formerly Statoil - Norway, 161 international subsidiaries), MOL (Hungary, 143), Gazprom (Russia, 130), and OOC (Oman, 125) round out the top five. Of these, only Gazprom and OOC are majority state-owned.^[ In each of the other firms, the state maintains a substantial minority stake in the firm and is the largest stakeholder.] A list of the top 20 NOCs by international subsidiaries can be found in \@ref(tab:toptbl).
...
```{r top20, fig.cap='The top 20 NOCs account for 80pct of NOC international subsidiaries', echo=F, fig.align='center', dpi=200, fig.height=4, fig.width=6, out.width='80%', eval=F}
subsidiaries %>% 
  filter(Type == "NOC") %>% 
  filter(Status == "international") %>%
  group_by(shortname) %>% 
  ...
  mutate(total = sum(n),
         cum_sum = cumsum(n),
         cum_share = cum_sum / total) %>%
  filter(cum_share < 0.8) %>% 
  ggplot(aes(reorder(shortname, n), n, label = n)) +
  geom_bar(stat = "identity",
           fill = "black"
           ) +
  geom_text(hjust = -.5) +
  labs(title = "",
       subtitle = "Top NOCs, ranked by number of International Subsidiaries",
       y = "",
       x = "") +
  coord_flip() +
  theme_few() +
...
```{r industries, fig.cap='NOC Subsidiaries by Industry', fig.height = 3, fig.width = 6, out.width='80%', fig.align= 'center', dpi=200, echo=F, message=F, warning=F, cache=T, eval=F}
subsidiaries %>% filter(Type == "NOC" & Status == "international") %>%
  select(industry) %>%
  ...
  mutate(total = 2746,
         share = n/total,
         cum_total = cumsum(n) / total) %>%
  mutate(Industry = case_when(cum_total < .8 & !grepl("Unknown|-", industry) ~ industry, 
                              grepl("Unknown|-", industry) ~ "Unknown",
                              TRUE ~ "Other")) %>%
  group_by(Industry) %>%
  summarize(n = sum(n)) %>%
  arrange(-n) %>%
  mutate(Industry = sub("Oil and Gas ", "", Industry)) %>% 
  ggplot(aes(reorder(Industry, n), n, label = n)) +
  geom_bar(stat = "identity",
           fill = "black"
           ) +
  geom_text(hjust = -.5) +
  labs(title = "",
       subtitle = "Count of NOC International Subsidiaries by Industry",
       y = "",
       x = "") +
  coord_flip() +
  theme_few() +
...
```{r scatter01,fig.cap='NOC Internationalization: Total number of International Subsidiaries (x) correlates strongly with breadth of the international subsidiary network (y). Points sized by median number of subsidiaries per location.', fig.height = 4, fig.width = 5,out.width='80%',  dpi=200,fig.align= 'center', echo=F, message=F, warning=F, cache=T}
subsidiaries %>% 
...
```{r t6map, fig.height = 4, fig.width = 8, fig.align= 'center', dpi=200, message=F, warning=F, echo=F, cache=T}
...
```{r overindex_tbl, fig.cap='13 Firms have double or more International subsidiaries compared to Domestic',fig.align= 'center', dpi=200, echo=F, eval=F}
subsidiaries %>% 
  filter(Type == "NOC") %>%
  select(shortname, country, subsidiary_country, Status) %>%
  group_by(shortname, country, Status) %>% 
  ...
  mutate(international = ifelse(is.na(international), 0, international)) %>% 
  mutate(domestic = ifelse(is.na(domestic), 1, domestic)) %>% 
  mutate(international_scaled = round(international / domestic, 1)) %>% 
  arrange(-international_scaled) %>% 
  filter(international_scaled > 3) %>% 
  rename(Firm = shortname,
         Country = country,
         `Dom. Sub.` = domestic,
         `Intl. Sub` = international,
         Indexed = international_scaled) %>% 
...
```{r dom_int_scatter, warning=F, message=F, echo=F, eval=F}
subsidiaries %>% 
  filter(Type == "NOC") %>%
  ...
  arrange(-international_scaled) %>% 
  mutate(tag = case_when(international_scaled > 2 ~ "tag",
                         TRUE ~ "notag")) %>% 
...
subsidiaries %>% 
  ...
  do(broom::tidy(cor.test(.$international_scaled, .$international)))
  #do(broom::tidy(cor.test(.$domestic, .$international)))
  #cor()
```

<!-- **Insert mapping analysis here** -->

<!-- This begs the question: can we quantify this geographical variation? This would require a methodology of measuring and then averaging the distance between nodes.  -->

<!-- **Insert geographical distance analysis here.** -->

<!-- We can look at the overall network established by relationships.  -->

<!-- **Insert ggmap network analysis here.** -->

### Are there political differences in how NOCs invest? {#iocnoc01}
...
```{r regress, fig.cap='Results', out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("fig/reg_results_01.png")
```
