...
```{r distributions, fig.height = 3, fig.width = 6, dpi=200, fig.cap='Distribution of International Subsidiaries', out.width='80%', fig.align='center', echo=FALSE, warning=F, message=F}
...
```{r toptbl, echo=F, warning=F, message=F}
subsidiaries %>% 
  filter(Type == "NOC") %>%
